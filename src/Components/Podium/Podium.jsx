...
const Podium = () => {
  ...
  return (
    <div id="Podiumsection-container">
        ...
        <div id='podiums-div'>
            <div className='podium2container animate__animated animate__fadeInUpBig'>
            ...
            <div className='podium1container animate__animated animate__fadeInUpBig'>
            ...
            <div className='podium3container animate__animated animate__fadeInUpBig'>
